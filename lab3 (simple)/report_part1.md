...
То, что у меня получилось можно наблюдать в этом [плохом CI/CD файле](/bad_practices.yml) и в [хорошем](/corrected_file.yml). Во втором исправлены ошибки первого, по сути они не отличаются. 
А о том, какие ошибки там были и почему они таковыми являются рассказано [тут](readme.md)
