...
У меня (Димы) то же самое, что и у Ксении, но я не так мучался с названиями и детализацией HTML, поэтому процесс в целом шёл намного быстрее. Большую часть времени помогал Ксении.  
