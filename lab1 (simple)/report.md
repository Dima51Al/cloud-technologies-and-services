...
Для создания псевдонимв путей мы использовали alias.
...
P.S. Этот отчёт был написан участником команды, который почти всё время всё ломал и не всегда понимал, что делать. Поэтому, пожалуйста, не пинайте меня (обращение в том числе и к напарнику).
